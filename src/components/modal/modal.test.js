...
import Modalfunction from '.';

describe('Form Component', () => {
  beforeEach(() => {
    // eslint-disable-next-line testing-library/no-render-in-setup
    const { getByTestId } = render(<Modalfunction />);
    const modal = getByTestId("openModal");
  ...
  it('submit form with empty values', () => {
    ...
    // expect(submit.getAttribute('disabled')).toEqual(true);
  });
  ...
  it('submit form with filled values', () => {
    ...
    // const submit = getByTestId("submit");
    // expect(submit.getAttribute('disabled')).toEqual(false);
  });
